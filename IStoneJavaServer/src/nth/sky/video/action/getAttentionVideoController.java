...
@Controller
public class getAttentionVideoController {
	@Resource
	private VideoInfoService videoInfoService;
	@RequestMapping("/getAttentionVideo.do")
	@ResponseBody
	//public String getAttentionVideo(User user,@RequestParam String appKey) {
	public void getAttentionVideo(HttpServletRequest request, HttpServletResponse response,@RequestParam("User") String json,@RequestParam String appKey) throws IOException {
		...
		if(appKey.equals(key.appKeyForJava)){
			...
			String RJson =new Gson().toJson(videoInfoService.getAttentionVideo(user));
			out.println(RJson);
		}
	   }
